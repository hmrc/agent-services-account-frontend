...
import support.Css.paragraphs
import uk.gov.hmrc.agentservicesaccount.controllers.ManageLandingController
...
import stubs.AgentPermissionsStubs.givenSyncEacdSuccess
import uk.gov.hmrc.http.SessionKeys

class ManageLandingControllerISpec
extends BaseISpec {

  val controller: ManageLandingController = inject[ManageLandingController]
