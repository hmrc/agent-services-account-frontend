...
class AgentServicesControllerSpec extends BaseISpec {
  ...
  "manage-account" should {
    ...
    "return status: OK and body containing content for status Opted-In_READY" in {
      ...
      h2.get(1).text shouldBe "Access groups"
      ...
      h2.get(2).text shouldBe "Settings"
      ...
      h2.get(3).text shouldBe "Make changes to your account"
      ...
      h2.get(4).text shouldBe "Contact details"
    ...
    "return status: OK and body containing content for status Opted-In_NOT_READY" in {
      ...
      h2.get(1).text shouldBe "Settings"
      ...
      h2.get(2).text shouldBe "Make changes to your account"
