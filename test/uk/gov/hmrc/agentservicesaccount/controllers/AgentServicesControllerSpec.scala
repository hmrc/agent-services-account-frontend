  ...
  "home" should {
    ...
    "return body containing the correct content" when {
      ...
      "an authorised agent with suspension disabled and IRV enabled and allowed" in {
        ...
        a.get(10).attr("href") shouldBe "http://localhost:9438/agent-mapping/start"
        a.get(11).attr("href") shouldBe "http://localhost:9448/invitations/agents/client-type"
        ...
        a.get(12).attr("href") shouldBe "https://www.gov.uk/guidance/sign-up-for-making-tax-digital-for-vat"
        expectedH4(html, "Manage your client’s VAT", 3)
        a.get(13).text shouldBe "Register your client for VAT (opens in a new tab)"
        a.get(13).attr("href") shouldBe "https://www.tax.service.gov.uk/register-for-vat"
        a.get(14).text shouldBe "Manage, submit and view your client’s VAT details (opens in a new tab)"
        a.get(14).attr("href") shouldBe "http://localhost:9149/vat-through-software/representative/client-vat-number"
        ...
        a.get(15).attr("href") shouldBe "http://localhost:9996/tax-history/select-client"
        ...
        a.get(16).attr("href") shouldBe "http://localhost:9448/invitations/agents/client-type"
        a.get(17).attr("href") shouldBe "https://www.gov.uk/guidance/register-your-clients-trust"
        a.get(18).attr("href") shouldBe "https://www.gov.uk/guidance/register-your-clients-estate"
        p.get(12).text shouldBe "Your client will need to claim the trust or estate."
        a.get(19).attr("href") shouldBe "https://www.gov.uk/guidance/manage-your-trusts-registration-service#how-to-use-the-online-service"
        ...
        a.get(20).text shouldBe "Use this service to update the details of your client’s trust or declare no changes on the trust register"
        a.get(20).attr("href") shouldBe "https://www.gov.uk/guidance/manage-your-trusts-registration-service"
        ...
        a.get(21).attr("href") shouldBe "https://www.gov.uk/guidance/managing-your-clients-capital-gains-tax-on-uk-property-account#before-you-start"
        p.get(15).text shouldBe "They must then authorise you to act on their behalf (opens in a new tab)"
        a.get(22).attr("href") shouldBe "https://www.gov.uk/guidance/managing-your-clients-capital-gains-tax-on-uk-property-account#get-authorisation"
        expectedH4(html, "Manage a client’s Capital Gains Tax on UK property", 7)
        a.get(23).text shouldBe "Report your client’s Capital Gains Tax on UK property and view payments and penalties"
        a.get(23).attr("href") shouldBe "https://www.tax.service.gov.uk/capital-gains-tax-uk-property/start"
        ...
        a.get(24).attr("href") shouldBe "https://www.gov.uk/guidance/register-for-plastic-packaging-tax"
        p.get(18).text shouldBe "They must then authorise you to act on their behalf"
        a.get(25).attr("href") shouldBe "http://localhost:9448/invitations/agents"
        ...
        a.get(26).attr("href") shouldBe "https://www.tax.service.gov.uk/plastic-packaging-tax/account"
        ...
        a.get(27).attr("href") shouldBe "https://www.gov.uk/government/collections/hmrc-online-services-for-agents#hmrc-online-services-for-agents-account"
        // end of accordion
