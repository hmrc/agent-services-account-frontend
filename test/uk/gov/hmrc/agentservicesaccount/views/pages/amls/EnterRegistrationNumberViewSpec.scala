...
class EnterRegistrationNumberViewSpec extends BaseISpec {
  ...
  "enter_registration_number" when {
    ...
    "first viewing page" should {
      ...
      val doc: Document = Jsoup.parse(view.apply(form, None)(FakeRequest(), messages, appConfig).body)
    ...
    "form is submitted with errors should" should {
      ...
      val doc: Document = Jsoup.parse(view.apply(formWithErrors, None)(FakeRequest(), messages, appConfig).body)
