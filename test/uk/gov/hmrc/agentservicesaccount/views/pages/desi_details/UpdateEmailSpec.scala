...
class UpdateEmailSpec
extends ViewBaseSpec {

  private implicit val langs: Seq[Lang] = Seq(Lang("en"), Lang("cy"))

  private val view: update_email = inject[update_email]
  ...
  object MessageLookup {
    ...
    object English {
      ...
      val hint: String =
        "We’ll use this email address to contact the business about the agent services account, and to send updates about authorisation requests."
    ...
    object Welsh {
      ...
      val hint: String =
        "Byddwn yn defnyddio’r cyfeiriad e-bost hwn i gysylltu â’r busnes ynghylch y cyfrif gwasanaethau asiant, ac i anfon diweddariadau ynghylch ceisiadau am awdurdodiad."
