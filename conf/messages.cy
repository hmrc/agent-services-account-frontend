...
manage.account.team-members.details.p1=Defnyddiwch y cysylltiad yn yr adran hon i greu Dynodydd Defnyddiwr (ID) newydd ar gyfer Porth y Llywodraeth ar gyfer aelodau eich tîm. Bydd y Dynodyddion Defnyddiwr (ID) hyn yn gysylltiedig â’r cyfrif gwasanaethau asiant.
manage.account.team-members.details.p2=Ar ôl i aelodau eich tîm ddilysu eu Dynodydd Defnyddiwr (ID) newydd, gallwch roi mynediad i’r cyfrif iddyn nhw. Gallwch hefyd ddileu mynediad aelod o’r tîm drwy ddefnyddio’r un cysylltiad.
manage.account.team-members.details.title=Sut i ychwanegu neu ddileu aelodau’r tîm
manage.account.team-members.external-manage-link=Creu Dynodydd Defnyddiwr (ID) ar gyfer Porth y Llywodraeth ar gyfer aelodau’r tîm (yn agor tab newydd)
