...
asa.h3.client-authorisations=Awdurdodiadau cleientiaid
asa.h3.manage=Rheoli eich cyfrif
asa.heading=Croeso i’ch cyfrif gwasanaethau asiant
asa.help.h2=Help ac arweiniad
asa.help.link=Rhagor o wybodaeth am sut i ddefnyddio’ch cyfrif gwasanaethau asiant a sut y gall cleientiaid eich awdurdodi i reoli eu trethi
asa.inset=Ni allwch fwrw golwg dros eich rhestrau o gleientiaid drwy’ch cyfrif gwasanaethau asiant. Gallwch ddefnyddio’ch cyfrif i fwrw golwg dros fanylion TAW  cleient unigol a’u rheoli.
...
asa.ppt.col1.link1=<a class="govuk-link" href="{0}" target="_blank" rel="noreferrer noopener">gofrestru ar gyfer y Dreth Deunydd Pacio Plastig gyntaf (yn agor tab newydd)</a>
asa.ppt.col1.link2=<a class="govuk-link" href="{0}" target="_blank" rel="noreferrer noopener">eich awdurdodi i weithredu ar ei ran</a>
asa.ppt.col1.text1=Mae’n rhaid i’ch cleient
asa.ppt.col1.text2=Yna mae’n rhaid iddo:
...
asa.section1.col2.h3=Rheoli manylion TAW eich cleient
...
asa.section3.col1.link1=<a class="govuk-link" href="{0}" target="_blank" rel="noreferrer noopener">sefydlu cyfrif Treth Enillion Cyfalaf ar eiddo yn y DU (yn agor tab newydd)</a>
...
asa.section3.col1.link2=<a class="govuk-link" href="{0}" target="_blank" rel="noreferrer noopener">eich awdurdodi i weithredu ar ei ran (yn agor tab newydd)</a>
asa.section3.col1.text1=Yn gyntaf mae’n rhaid i’ch cleient:
asa.section3.col1.text2=Yna mae’n rhaid iddo:
...
asa.section4.col1.link0=Gofyn i gleient eich awdurdodi
...
asa.section4.itsa.notification.h2=Paratowch ar gyfer y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm
asa.section4.itsa.notification.p.1=Gallwch ddefnyddio awdurdodiadau cleient Hunanasesiad i reoli Troi Treth yn Ddigidol ar gyfer Treth Incwm.
asa.section4.itsa.notification.p.2=I wneud hyn, sicrhewch fod eich holl awdurdodiadau cleient Hunanasesiad wedi’u hychwanegu at y cyfrif hwn
...
asa.legacy.ct.confirmation.title=We’re processing your application
asa.legacy.ct.confirmation.panel.body=You’ll get an agent code within 5 days
asa.legacy.ct.confirmation.p1=You’ll receive an email once your agent code is ready. You can then use it to ask for authorisation from your clients.
...
asa.legacy.paye.confirmation.title=We’re processing your application
asa.legacy.paye.confirmation.panel.body=You’ll get an agent code within 5 days
asa.legacy.paye.confirmation.p1=You’ll receive an email once your agent code is ready. You can then use it to ask for authorisation from your clients.
...
asa.legacy.sa.alf.lookup.postcode.label=Postcode
...
asa.legacy.sa.alf.edit.townLabel=Address line 4
...
asa.legacy.sa.confirmation.title=We’re processing your application
asa.legacy.sa.confirmation.panel.body=You’ll get an agent code within 5 days
asa.legacy.sa.confirmation.p1=You’ll receive an email once your agent code is ready. You can then use it to ask for authorisation from your clients.
asa.legacy.sa.confirmation.p2=We’ll also send you a letter with your agent code for your records.
asa.legacy.sa.confirmation.p3=This code must be kept private. Only share it with people who genuinely need to know it.
asa.legacy.sa.return-home=Return to your agent services account homepage
...
common.continue.without.code=Yn eich blaen heb god
...
help.cannot.link3=Treth Gorfforaeth
help.cannot.link4=Awdurdodi asiant ar gyfer gwasanaethau treth eraill
...
help.itsa.h2=Troi Treth yn Ddigidol ar gyfer Treth Incwm ar gyfer Hunanasesiad (ITSA)
help.itsa.link1=Troi Treth yn Ddigidol ar gyfer Treth Incwm fel asiant: cam wrth gam
help.itsa.link2=Defnyddio Troi Treth yn Ddigidol ar gyfer Treth Incwm
help.itsa.link3=Sut i gofrestru cleientiaid am y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm
...
help.mtd.link3.href=https://www.gov.uk/guidance/sign-up-your-client-for-making-tax-digital-for-vat.cy
...
help.trusts.link2.href=https://www.gov.uk/guidance/register-your-clients-trust.cy
...
manage.account.amls.add=Gweithred: Ychwanegwch fanylion ynghylch goruchwyliaeth gwrth-wyngalchu arian
manage.account.amls.view=Bwrw golwg dros neu ddiweddaru manylion ynghylch goruchwyliaeth gwrth-wyngalchu arian
manage.account.amls.update=Gweithred: Diweddaru manylion ynghylch goruchwyliaeth gwrth-wyngalchu arian
...
manage.account.your-organisation.heading=Gosodiadau ar gyfer cyfrif eich sefydliad
manage.account.manage-sign-in-details.heading=Rheoli’ch manylion mewngofnodi eich hun
manage.account.manage-sign-in-details.link=Bwrw golwg dros neu newid eich manylion mewngofnodi a’ch manylion diogelwch
...
manage.account.manage-access-permissions.access-groups.create-new.a=Creu grŵp mynediad newydd
manage.account.manage-access-permissions.access-groups.hint=Mae grwpiau mynediad yn caniatáu ichi gyfyngu ar ba aelodau’r tîm all reoli treth cleient.
manage.account.manage-access-permissions.access-groups.manage.a=Rheoli grwpiau mynediad
manage.account.manage-access-permissions.heading=Rheoli grwpiau mynediad
manage.account.manage-access-permissions.inset-text.OptedInNotReady=Rydych wedi galluogi grwpiau mynediad ond mae angen i chi aros nes bod manylion eich cleientiaid yn barod i’w defnyddio gyda grwpiau mynediad. Byddwch yn cael e-bost cadarnhau, ac ar ôl hynny gallwch ddechrau defnyddio’r grwpiau mynediad.
manage.account.manage-access-permissions.inset-text.OptedInSingleUser=I ddefnyddio grwpiau mynediad, mae angen i chi ychwanegu rhagor o aelodau’r tîm at eich cyfrif gwasanaethau asiant o dan ‘Rheoli aelodau’r tîm ar eich cyfrif gwasanaethau asiant’.
manage.account.manage-access-permissions.inset-text.OptedOutSingleUser=I ddefnyddio grwpiau mynediad, mae angen i chi ychwanegu rhagor o aelodau’r tîm at eich cyfrif gwasanaethau asiant o dan ‘Rheoli aelodau’r tîm ar eich cyfrif gwasanaethau asiant’.
manage.account.manage-access-permissions.inset-text.OptedOutWrongClientCount=I ddefnyddio grwpiau mynediad, mae angen i chi gael mwy nag 1 cleient yn eich cyfrif gwasanaethau asiant.
...
manage.account.manage-user-access=Dewis pa drethi a chynlluniau y gall aelodau’r tîm gael mynediad atynt
...
manage.account.team-members.details.p1=Pan fyddwch yn ychwanegu aelod o’r tîm, cewch gyfrinair dros dro i’w roi iddo.  Byddwn hefyd yn ei e-bostio gyda Dynodydd Defnyddiwr (ID) newydd ar gyfer Porth y Llywodraeth.
manage.account.team-members.details.p2=Bydd y Dynodydd Defnyddiwr (ID) newydd hwn yn galluogi’r aelod o’r tîm i gael mynediad at y cyfrif gwasanaethau asiant hwn.
manage.account.team-members.details.p3=Gall gweinyddwr benderfynu ar y lefel o fynediad sydd gan yr aelod o’r tîm at fanylion, trethi a chynlluniau’r cleient.
manage.account.team-members.details.title=Sut i ychwanegu neu ddileu aelodau’r tîm
manage.account.team-members.external-manage-link=Ychwanegu, tynnu a rheoli aelodau’r tîm
manage.team-members.groups.a=Rheoli grwpiau mynediad aelodau’r tîm
manage.team-members.groups.heading=Rheoli grwpiau mynediad aelodau’r tîm
...
your.account.your.info.h2=Eich manylion mewngofnodi ar gyfer eich cyfrif gwasanaethau asiant
...
your.account.your.info.mfa.link=Newidwch eich manylion mewngofnodi neu’ch manylion diogelwch
...
your.account.your-organisation.heading=Eich sefydliad
