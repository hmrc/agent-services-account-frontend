...
agent.services.account.section1.col2.link1=Cofrestru’ch cleient ar gyfer TAW (yn agor tab newydd)
agent.services.account.section1.col2.link2=Rheoli, cyflwyno a bwrw golwg dros fanylion TAW eich cleient (yn agor mewn tab newydd)
...
beta.invite.yes-no.conditional.label=Sawl cleient sydd gennych?
beta.invite.yes-no.conditional.label.small=1,000 neu lai
beta.invite.yes-no.conditional.label.small=Rhwng 1,001 a 5,000
beta.invite.yes-no.conditional.label.small=Mwy na 10,000
