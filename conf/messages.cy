...
manage.account.manage-access-permissions.inset-text.Opted-In_NOT_READY=You have added new clients but need to wait until your client details are ready to use with access groups. You will receive a confirmation email after which you can start using access groups.
manage.account.manage-access-permissions.inset-text.Opted-Out_WRONG_CLIENT_COUNT=To use access groups you need to have more than 1 client in your agent services account.
manage.account.manage-access-permissions.inset-text.Opted-Out_SINGLE_USER=To use access groups you need to add more team members to your agent services account under ‘Manage team members’ below.
...
manage.account.clients.hint=View client details, update client reference and see what groups a client is in.
manage.account.clients.manage=Manage clients
manage.account.clients.unassigned=Unassigned clients

manage.account.team-members.heading=Team members
manage.account.team-members.hint=View team member details and see what groups a team member is in.
manage.account.team-members.manage=Manage team members
manage.account.team-members.add-remove=Add or remove team members (opens in a new tab)
...
agent.services.account.p.agent-services=Mynediad at wasanaethau ar gyfer cleientiaid sydd eisoes wedi eich awdurdodi i weithredu ar eu rhan.

agent.services.account.h3.client-authorisations=Awdurdodiadau cleientiaid
agent.services.account.p.client-authorisations=Dechrau cais am awdurdodiad newydd neu gysylltu’ch cleientiaid cyfredol â’ch cyfrif.

agent.services.account.h3.manage=Rheoli eich cyfrif
...
agent.services.account.additional.links.agent-afi.ga.services-you-need=Gwasanaethau y mae’n bosibl y bydd eu hangen arnoch
agent.services.account.additional.links.agent-afi.ga.request-auth=Gofyn i gleient eich awdurdodi
agent.services.account.additional.links.agent-afi.ga.view-income-record=Bwrw golwg dros gofnod incwm cleient
